    ...
    <html lang="en">
      ...
      <body class="bg-paper font-sans text-navy antialiased">
        ...
        <footer class="mt-16 border-t border-line bg-panel">
          ...
          <div class="border-t border-line">
            <div class="mx-auto max-w-5xl px-4 py-5 text-xs leading-5 text-navy-soft">
              <p>
                Published by{" "}
                <a
                ...
                <a
                  ...
                  class="hover:text-amber-deep underline"
                >
                  about
                </a>{" "}
                and{" "}
              ...
              >
                ...
                <a href="https://qr.toolsbay.app" class="hover:text-amber-deep">
                  QR codes
                </a>
                <a
                  href="https://toolsbay.app/about"
                ...
                <a href="/privacy-policy" class="hover:text-amber-deep">
                  Privacy
                </a>
              </nav>
            </div>
