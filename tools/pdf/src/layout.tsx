      ...
      <body class="bg-cream font-sans text-ink antialiased">
        ...
        {crumbs && (
          <nav
            ...
            class="mx-auto max-w-5xl px-4 pt-3 text-[13px] text-muted"
          >
              ...
              {crumbs.map(([label, href], i) => (
                <li class="flex items-center gap-1.5">
                  ...
                  {i === crumbs.length - 1 ? (
                    ...
                    <a href={href} class="hover:text-brick-deep">
                      {label}
                    </a>
                  )}
                </li>
        ...
        <footer class="mt-16 border-t border-line bg-panel">
          ...
          <div class="border-t border-line">
            <div class="mx-auto max-w-5xl px-4 py-5 text-xs leading-5 text-muted">
              <p>
                Published by{" "}
                <a
                ...
                <a
                  ...
                  class="hover:text-brick-deep underline"
                >
                  about
                </a>{" "}
                and{" "}
              ...
              >
                ...
                <a href="https://qr.toolsbay.app" class="hover:text-brick-deep">
                  QR codes
                </a>
                <a
                  href="https://toolsbay.app/about"
                ...
                <a href="/privacy-policy" class="hover:text-brick-deep">
                  Privacy
                </a>
              </nav>
            </div>
