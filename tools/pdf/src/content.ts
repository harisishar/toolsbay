...
export const TOOLS: Tool[] = [
  ...
  },
  {
    ...
    intro: 'Turn each PDF page into a PowerPoint slide you can edit and present.',
    faq: [serverFaq],
  },
  {
    slug: 'word-to-pdf',
  ...
  },
  {
    ...
    h1: 'Excel to PDF',
    intro: 'Share spreadsheets that look the same everywhere — converted to PDF page by page.',
    faq: [serverFaq],
  },
  {
    ...
    intro: 'Turn slides into a PDF anyone can open — one slide per page, formatting intact.',
    faq: [serverFaq],
  },
  {
    slug: 'ocr-pdf',
...
export const CATEGORIES = ['Organize', 'Convert', 'Edit & Sign', 'Security', 'More'] as const;
